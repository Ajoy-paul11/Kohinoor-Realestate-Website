          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 shrink-0">
              <div className="text-right">
                ...
                <p className="text-3xl font-semibold text-[#cbb58b]">{aquarise.price}</p>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <article className="lg:col-span-2 space-y-10">
            ...
            <div className="prose prose-invert max-w-none text-neutral-300 prose-headings:text-white prose-a:text-[#cbb58b]">
              ...
              <p>
                <strong>Binghatti Aquarise</strong> is a striking residential tower in the heart of
          ...
          <aside className="space-y-5">
            ...
            <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-6">
              ...
              <ul className="space-y-2 text-sm text-neutral-300">
                {["Artificial Beach", "Sunken Seating", "Swimming Pool"].map((f) => (
