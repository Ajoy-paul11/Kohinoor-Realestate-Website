...
import img1 from "../../assets/images/aquarise/aquarise1.webp";
import img2 from "../../assets/images/aquarise/aquarise2.webp";
import img3 from "../../assets/images/aquarise/aquarise3.webp";
import img4 from "../../assets/images/aquarise/aquarise4.webp";
import img5 from "../../assets/images/aquarise/aquarise5.webp";
import img6 from "../../assets/images/aquarise/aquarise6.webp";
import img7 from "../../assets/images/aquarise/aquarise7.webp";
...
export default function AquarisePage() {
  return (
      ...
      <section className="border-b border-neutral-800/60">
        <div className="max-w-7xl mx-auto px-6 pt-10 pb-6">
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
            <div>
              ...
              <p className="mt-2 text-neutral-400 text-sm tracking-wide">
                Business Bay · Dubai · {aquarise.category}
              </p>
            </div>
          ...
          <div className="mt-6 flex flex-wrap gap-6 text-sm">
            {[
              { label: "Building", value: "Studio – 4 BR" },
              { label: "Floors", value: "25" },
              { label: "Total units", value: "1,598" },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <article className="lg:col-span-2 space-y-10">
            ...
            <div className="prose prose-invert max-w-none text-neutral-300 prose-headings:text-white prose-a:text-[#cbb58b]">
              ...
              <p>
                <strong>Binghatti Aquarise</strong> is a striking residential
                tower in the heart of Business Bay, Dubai — brought to life by
                one of the UAE's most iconic developers. With an investment
                portfolio valued at <strong>AED 40 billion</strong>, Binghatti
                is renowned for its daring, futuristic designs and its
                world-first partnerships with global luxury brands including{" "}
          ...
          <aside className="space-y-5">
            ...
            <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-6">
              ...
              <dl className="space-y-3 text-sm">
                {[
                  ["Project", aquarise.name],
                  ["Developer", "Binghatti"],
                  ["Location", "Business Bay, Dubai"],
                  ["Building type", "Studio to 4 BR Apartments"],
                  ["Floors", "25"],
                  ["Total units", "1,598"],
                  ["Property size", "434 ft²"],
                ].map(([label, value]) => (
                  <div
                    key={label}
            ...
            <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-6">
              ...
              <ul className="space-y-2 text-sm text-neutral-300">
                {["Artificial Beach", "Sunken Seating", "Swimming Pool"].map(
                  (f) => (
