...
const features = [
    {
        ...
        description: "Personalized advisory for investors seeking long-term value in the luxury market.",
        icon: HouseHeart
    },
    {
        id: 2,
        headline: "Unmatched Craftsmanship",
        description: "Attention to detail, from interiors to textures, ensuring perfection in every inch.",
        icon: Wrench
    },
    {
        id: 3,
        headline: "Prime Luxury Locations",
        description: "Exclusive neighborhoods for prestige, privacy, and beauty — every sunrise feels curated.",
        icon: Gem
    },
    {
        id: 4,
        headline: "Sustainable Innovation",
        description: "Luxury with smart systems, energy efficiency, and timeless materials.",
        icon: Brain
    }
];
        ...
        <motion.div
         ...
         className=" flex flex-col h-full">
          <div className=" flex flex-col h-full w-full mx-auto gap-6">
            ...
            <div key={feature.id} className=" w-full max-w-full p-6 bg-[#121212] border border-[#1E1E1E] rounded-lg flex flex-col gap-6">
              <div className=" flex gap-2 items-center text-left flex-row-reverse">
                ...
                <div className=" w-full grow text-left">
                    <h3 className=" text-xl md:text-2xl font-normal mb-4"> {feature.headline}</h3>
                    <p className=" text-sm md:text-lg font-normal"> {feature.description}</p>
                </div>
              </div>
            </div>
            ))}
