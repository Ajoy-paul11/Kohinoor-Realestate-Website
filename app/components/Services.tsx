              ...
              <div className=" w-[90%] max-w-full">
                <div className=" text-left flex flex-col">
                  ...
                  <div className=" grow w-full text-left ">
                    ...
                    <p>
                      Architectural masterpieces built with integrity,
                      innovation, and world-class craftsmanship.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className=" w-[90%] max-w-full">
                <div className=" text-left flex flex-col">
                  ...
                  <div className=" grow w-full text-left ">
                    ...
                    <p>
                      Personalized advisory for investors seeking long-term
              ...
              <div className=" w-[90%] max-w-full">
                <div className=" text-left flex flex-col">
                  ...
                  <div className=" grow w-full text-left ">
                    ...
                    <p>
                      Curated interiors that blend modern minimalism with
                      timeless refinement.
                    </p>
                  </div>
                </div>
